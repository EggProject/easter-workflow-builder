...
| `src/screenshot-pipeline/`        | téma mappa, megvalósítás fájl nélkül: a képernyőkép készítés egyetlen szentesített útját őrző nyolc invariáns (a szentesített fájlon kívül semmi nem ír képet lemezre, a formátumtól és az írás módjától függetlenül, az import gráfon át, a CDP képernyőképen és a trace képernyőképein át sem, a képernyőkép, a trace és a trace képernyőkép opció zárt listás; a szentesített script nem tart saját gráfot vagy mockot; az `apps/web/e2e/screenshot-manifest.json` bizonyíték lenyomata friss; a hetedik az első ellenőrzését harmincnégy szintetikus eseten futtatja; és a nyolcadik a saját forrásából ellenőrzi, hogy az első ezt a függvényt futtatja) |
