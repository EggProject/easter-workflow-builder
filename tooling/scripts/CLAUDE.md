...
| `src/screenshot-pipeline/`        | téma mappa, megvalósítás fájl nélkül: a képernyőkép készítés egyetlen szentesített útját őrző hét invariáns (a szentesített fájlon kívül semmi nem ír képet lemezre, a formátumtól és az írás módjától függetlenül, az import gráfon át sem; a szentesített script nem tart saját gráfot vagy mockot; az `apps/web/e2e/screenshot-manifest.json` bizonyíték lenyomata friss; és a hetedik az első ellenőrzését szintetikus kerülő utakon futtatja) |
