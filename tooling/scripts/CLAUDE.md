...
| `src/screenshot-pipeline/`        | téma mappa, megvalósítás fájl nélkül: a képernyőkép készítés egyetlen szentesített útját őrző hat invariáns (a szentesített fájlon kívül semmi nem ír képet lemezre, a szentesített script nem tart saját gráfot vagy mockot, és az `apps/web/e2e/screenshot-manifest.json` bizonyíték lenyomata friss)                                                                                                                                   |
