...
(`isRunInterruptible`). A második szakaszt a `run_finished` esemény zárja le: a `RunViewScreen`
arra a keretre tölti újra a futás rekordját, és az új, terminális állapot váltja át a sávot. Nincs
