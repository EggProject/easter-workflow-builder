...
`run-graph` (T-009-20, huszonkettedik) és `run-view` (T-009-20, huszonharmadik). A SPEC-008 11.2
szekciója tíz új témát ír elő összesen (a maradék három a PLAN-009 hátralévő lépéseiben
érkezik); a végleges
