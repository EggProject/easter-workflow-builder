...
| `src/graph-node-card/`                 | a vászon egyetlen egyedi node komponense, a `Handle` elemekkel és a `StepRunStatus` jelvény leképezéssel, plusz a mért kártya méret konstans CSS custom propertyvé fordítása (`GraphNodeCardSizeStyle`, mindkét vászon fogyasztja) (SPEC-008 5.1, 5.5, AC21)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
