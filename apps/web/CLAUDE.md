...
rendereli, a többi képernyő mintáját követve. **Ismert, szándékosan átmeneti gap**: a
`graph-editor-screen.css` `.graph-editor-screen__canvas` magassága `70vh`, nem az
`.app-content`-ből számított - az utóbbi ma nem ad definit magasságot a gyerekeinek, ezt a
T-009-22 (SPEC-008 F4, `run-view` osztott elrendezés) oldja meg. Enélkül a vászon `height: 100%`
szabálya 0-ra oldódna, azaz láthatatlan lenne.
