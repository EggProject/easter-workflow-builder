...
`subscribeToFrames` útján jönnek, nem a `lastFrame` állapotból**, mert az egy löketből csak az
utolsó keretet adja át (saját mérés, `docs/research/2026-09-23-transcript-panel-meresek.md`); a
...
| `src/stream-client/`                   | `EventSourceFactory` és `streamId` generátor port, az öt SSE keret feldolgozása, a topnav státusz négy fázisa (SPEC-007 9. szekció), és a veszteségmentes `subscribeToFrames` feliratkozás, ami a löketben érkező kereteket egyenként adja át (T-009-25); a `subscribe-to-stream-frames.ts` **típus only** (nincs `.spec.ts` párja)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
