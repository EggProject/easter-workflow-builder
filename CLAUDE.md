...
A projekt szabályai a `.claude/CLAUDE.md` szabálykönyvben élnek, egyetlen, folyamatosan
karbantartott helyen. Ez a fájl (1-7. szekció) a felhasználó saját, kézzel írt viselkedési
szabálykönyve marad, és nem duplikálja a projekt szabályait.
