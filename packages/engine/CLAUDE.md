...
A csomag a PLAN-005 F3 fázisában épül fel, lépésenként egy-egy téma mappával. Ma hat téma áll
...
(T-005-10), az ág hatókör verem a kiegyensúlyozottság ellenőrzésével (T-005-11) és a háromszintű
provider feloldás (T-005-12). A tényleges ütemező, a node végrehajtók és a spec 12. szekciójában
felsorolt további téma mappák a PLAN-005 hátralévő lépéseiben készülnek.
