...
A csomag a PLAN-005 F3 fázisában épül fel, lépésenként egy-egy téma mappával. Ma nyolc téma áll
...
provider feloldás (T-005-12), a leírótól függő viselkedések (T-005-13) és a kötelező/tiltott env
változók feldolgozása (T-005-14). A tényleges ütemező, a node végrehajtók és a spec 12.
