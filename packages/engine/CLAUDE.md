...
**Amit a `fail_run` ma NEM visz el, kimondva (mérve, SPEC-004 8.3 "Nyitott"):** a testvér
`sub_workflow` lépés gyerek futását, mert a leállítás a saját `runId`-ra szűkít: ha a gyerek
jóváhagyásra vár, a bukott szülő a bukás után sem terminális. Megnevezett hiány, nem elfogadott
végállapot.
