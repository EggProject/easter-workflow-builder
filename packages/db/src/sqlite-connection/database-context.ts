 ...
 * `RunEventRepository`-t (T-003-21); a többi repository mező a következő
 * témák elkészültével bővül ide (`human-approval`, ...), a SPEC-003 9.1
 * szekció `DatabaseContext` alakja szerint.
 */
