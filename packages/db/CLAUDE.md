...
| `workflow-graph/workflow/`          | `workflow`, `workflow_node`, `workflow_edge` tábla (SPEC-003 4.1, 4.2, 4.7 szekció) és a `WorkflowRepository` (T-003-12), ami mind a hármat egyetlen tranzakcióban írja                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `workflow-graph/node-type/`         | a `NodeType` unió, a tíz node típus szótára, és az `isNodeType` guard (T-003-11)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `workflow-graph/node-config/`       | a node config unió és mind a tíz ága, az `isNodeConfig` guard, a `script-config.ts` alobjektum (T-003-11); az `isStringArray` segédet a `@easter-workflow-builder/typeguards` csomag adja (PLAN-004 4.5 szekció)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `workflow-graph/agent-step-config/` | az `AgentStepConfig` és az `isAgentStepConfig` guard, plusz a mezőalakjai: `storable-mcp-server.ts`, `sandbox-config.ts`, `engine-hook-id.ts`, `session-mode.ts` (T-003-11)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `graph-snapshot/stored-snapshot/`   | a `graph_snapshot` tábla (`hash` elsődleges kulcs, `graph_snapshot_version_idx` index, nincs idegen kulcsa) és a `graph_snapshot_no_update` `BEFORE UPDATE` trigger, ami minden módosítási kísérletet `SQLITE_CONSTRAINT_TRIGGER` hibával buktat meg (SPEC-003 4.9 és 5.5 szekció, T-003-15); a `resolveSnapshotReuse` döntő függvény, ami eldönti, a meglévő sort használjuk-e vagy újat szúrunk be                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `graph-snapshot/snapshot-document/` | a pillanatkép dokumentum típusa és verzió uniója, a `GRAPH_DOCUMENT_VERSION`, a verziódiszpécser `readGraphSnapshot` és a hozzá tartozó typeguardok (SPEC-003 5. szekció, T-003-14)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `graph-snapshot/snapshot-hash/`     | az RFC 8785 kanonizáló, a `sha256` lenyomat képzés, plusz a commitolt fixture és a rá épülő regressziós teszt, ami a lenyomat literált őrzi                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `human-approval/`                   | a `human_approval` tábla (SPEC-003 4.12 szekció): `run_id` idegen kulcs `ON DELETE CASCADE` a `workflow_run` táblára, `step_run_id` idegen kulcs `ON DELETE CASCADE` a `step_run` táblára, két index (`human_approval_step_uq` **egyedi** a `(step_run_id)` oszlopon, `human_approval_pending_idx` a `(decision, requested_at_ms)` páron, F-10: SQLite az indexben tárolja a NULL `decision` értéket is). Az `ApprovalDecision` unió (`'approved' \| 'rejected'`) és az `isApprovalDecision` guard a barrelben is szerepel. A `HumanApprovalRepository`: `requestApproval` (beszúrja a sort `decision: null` értékkel, ÉS ugyanabban a tranzakcióban `running -> waiting_approval` állapotba viszi a lépés futást a `StepRunRepository.markStepWaitingApproval` hívásával), `decideApproval` (compare-and-set `UPDATE ... WHERE step_run_id = ? AND decision IS NULL`, majd `markStepSucceeded`/`markStepRejected`, ugyanabban a tranzakcióban - ha az állapotváltás hibázik, a döntés írása is visszagördül), `getApproval` (azonosító szerint, a döntéstől és a lépés állapotától függetlenül, user döntés 2026-09-23), `getApprovalForStep` és `listPendingApprovals` (a `step_run` sorára kötve `WHERE decision IS NULL AND step_run.status = 'waiting_approval' ORDER BY requested_at_ms`, egyetlen lekérdezésben, user döntés 2026-09-23; T-003-22).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `run-recovery/`                     | **nincs saját tábla**: a szerver indulási helyreállítása (SPEC-003 7.4 szekció, "Szerver leállás") ÉS a szabályos leállás (SPEC-004 10.2 szekció), ami a `workflow_run` ÉS a `step_run` táblát EGYÜTT érinti, ezért egyik témába sem tartozik (8. szekció). A `RunRecovery.recoverInterruptedRuns(reason)` egyetlen tranzakcióban: minden `pending`/`running` futás `interrupted` állapotba, a hozzájuk tartozó minden nem terminális (`pending`/`running`/`waiting_approval`) lépés futás szintén, majd futásonként EGY `run_interrupted` motor esemény (`origin: 'engine'`, `stepRunId: null`, `payload: { reason }`) - tömeges `UPDATE ... WHERE status IN (...) RETURNING id` alakban, NEM a `markRunInterrupted`/`markStepInterrupted` egyenkénti hívásával iterálva (lásd lent, T-003-24). **A `reason: RunInterruptedReason` paraméter a T-005-27 óta**: EGYETLEN függvény, két hívó - a `packages/engine` `startup-recovery` témája `'startup_recovery'` értékkel, a `run-interrupt` témája szabályos leállásnál `'graceful_shutdown'` értékkel hívja, mert a SPEC-004 10.2 szekció szó szerint kimondja: "a két út eredménye az adatbázisban megkülönböztethetetlen ... nem kell külön ágat karbantartani". **A `cancelRunTree(rootRunId)` a T-005-26 óta**: ugyanaz a tömeges minta, de a `root_run_id` oszlopra szűkítve (`workflow_run_root_idx` index, egyetlen futás fájára, a felhasználó explicit megszakítási kérésére), célállapot `cancelled`, `run_finished` esemény (`status: 'cancelled'`, `errorKind`/`errorMessage`: `null`, `failedBranchCount: 0`) `run_interrupted` helyett - a `packages/engine` `run-interrupt` témájának `interruptRun` művelete hívja. **A `cancelRuns(runIds)` 2026-09-23 óta**: ugyanaz a tranzakció, közös belső menettel, a hatókör viszont a megnevezett futások listája; a `packages/engine` `fail_run` hibapolitikája hívja a bukott futás al-workflow futásaira, amiket a motor a memóriájából gyűjt, mert a `root_run_id` szerinti szűrés a bukott futást és az őseit is elvinné (SPEC-004 8.3). A `DatabaseContext.recovery` mező adja, ez az utolsó mező, amivel mind a 12 téma mappa elkészült. Az `openDatabase` **nem** hívja automatikusan: a `packages/db` csak a képességet adja, a `recoverInterruptedRuns` hívása az `apps/server` felelőssége lesz egy KÉSŐBBI specifikációban, a szerver indulásakor, hálózati kapcsolat fogadása előtt. |
...
A `workflow-graph` tárgykör mappa négy témára oszlik (PLAN-004 4.1 szekció): a `node-type/`
a `node-type.ts` uniót és az `is-node-type.ts` guardot tartja; a `node-config/` a
`node-config.ts` uniót (mind a tíz ág), az `is-node-config.ts` guardot és a `script-config.ts`
alobjektumot; az `agent-step-config/` az `agent-step-config.ts` típust, az
`is-agent-step-config.ts` guardot és a mezőalakjait (`storable-mcp-server.ts`,
`sandbox-config.ts`, `engine-hook-id.ts`, `session-mode.ts`). Mindkét guard az `isStringArray`
segédet a `@easter-workflow-builder/typeguards` csomagból importálja, mert a segédnek nincs
domain témája (PLAN-004 4.5 szekció). Egyik fájl sem kerül a barrelbe: a publikus felületet a
repository réteg adja (T-003-12).
...
A `graph-snapshot/stored-snapshot/graph-snapshot.ts` a `graph_snapshot` tábla Drizzle definíciója: `hash` elsődleges kulcs
...
`markStepFailed`, `markStepRejected`, `markStepCancelled`), az `attachSession` és az
`attachSubWorkflowRun` műveletet adja,
...
**Két `attach*` művelet, egyik sem állapotváltás.** Az `attachSession` a `system` `init` SDK
üzenet három session mezőjét írja (SPEC-003 4.5), az `attachSubWorkflowRun` a
`sub_workflow_run_id` oszlopot (4.10). Mindkettő sima `UPDATE ... WHERE id = ?`, compare-and-set
`status IN (...)` feltétel nélkül, és hiányzó sorra `not_found` hibaágat ad, nem
`illegal_status_transition`-t. Az `attachSubWorkflowRun` azért kell külön műveletként, mert a
`sub_workflow` végrehajtó a lépés sorát a gyerek futás **előtt** hozza létre (a rekurzióvédelem
hibaága is lezárt lépés sort igényel, és a `sub_workflow_started` esemény lépés szintű), a gyerek
futás azonosítója viszont csak a `startRun` után létezik (SPEC-004 5.9, `packages/engine`
`node-executor` téma).
...
`workflow-graph/workflow/workflow-repository.ts` `CreateWorkflowInput`-jának mintáját követve
...
A `human-approval-repository.ts` a `requestApproval`, `decideApproval`, `getApproval`,
`getApprovalForStep` és `listPendingApprovals` műveletet adja, `openDatabase` köti be a `DatabaseContext.approvals`
...
**A `listPendingApprovals` a lépés állapotából dönt, nem a `decision` oszlopból** (user döntés
2026-09-23, SPEC-003 4.12). A döntés nélkül lezárt jóváhagyás (megszakítás, `fail_run`, a
`sub_workflow` fa lezárása, időkorlát) `decision` mezője NULL marad, a lépése viszont már nem
`waiting_approval`. A lekérdezés ezért `innerJoin`-nal a `step_run` sorára köt, és a `decision IS
NULL` mellett a `step_run.status = 'waiting_approval'` feltétellel szűr, egyetlen `SELECT`-ben: a
lépés sorának lezárása után a jóváhagyás egyik listában sem jelenik meg. A `decision IS NULL`
feltétel is marad, ez tartja fenn a `toPendingApprovalRecord` `decision: null` garanciáját. A
`getTableColumns(humanApprovalTable)` kiválasztás miatt a sor alakja változatlanul a
`human_approval` tábla sora. A `getApproval(approvalId)` az `apps/server` döntési végpontjának
olvasója: `not_found` csak nem létező azonosítóra, a már eldöntött vagy lezárt jóváhagyás a
`decideApproval` compare and set hibáján át `conflict` (SPEC-005 4.2).
...
**`recoverInterruptedRuns(reason)` lépései, egyetlen tranzakcióban** (`run-recovery.ts`):
...
4. Futásonként EGY `run_interrupted` motor esemény (`origin: 'engine'`, `stepRunId: null`,
   `payload: { reason }`, a hívó `RunInterruptedReason` paraméterével), az `insertEngineEventRow`
   (`run-event/event-record/insert-engine-event-row.ts`) PLAIN, tranzakció nélküli
   segédfüggvénnyel - ugyanaz a minta, mint a `workflow-run-repository.ts` `startRun`-jában a
   `run_started` eseménynél, beleértve azt is, hogy a visszaadott `Outcome`-ot itt sem ágaztatjuk
   el (a `not_found` ág logikailag kizárt, mert a `runId` az imént, ugyanebben a tranzakcióban
   lett kiolvasva).

**A `reason: RunInterruptedReason` paraméter (`'startup_recovery' | 'graceful_shutdown'`) a
T-005-27 óta.** A `packages/engine` `RunInterruptedPayload` típusa (`run-interrupted-payload.ts`)
szó szerint ugyanezt az uniót ismétli - a `db` réteg nem importálhatja az `engine` típusát
(fordított rétegirány lenne). **Egyetlen függvény, két hívó, nem külön ág**: a SPEC-004 10.2
szekció szó szerint kimondja, hogy "a szabályos és a durva leállás ugyanoda érkezik ... a két út
eredménye az adatbázisban megkülönböztethetetlen, tehát a helyreállítás idempotens, és nem kell
külön ágat karbantartani. Ez szándékos." A `packages/engine` `startup-recovery` témája a szerver
indulásakor `'startup_recovery'` értékkel, a `run-interrupt` témája szabályos leálláskor
(`SIGINT`/`SIGTERM`) `'graceful_shutdown'` értékkel hívja - mindkét hívás a TELJES adatbázisra
hat (minden `pending`/`running` sor, nem egyetlen futás fája), ellentétben a `cancelRunTree`
`root_run_id` szerinti szűkítésével.
...
`RunRecovery`, a `RecoverInterruptedRunsResult`, a `CancelRunTreeResult` és (T-005-27 óta) a
`RunInterruptedReason` típust exportálja, a `createRunRecovery` factory függvényt nem (SPEC-002
6.6 5. szabálya, SPEC-003 9.3 szekció).
...
kapcsolatot", és azt sem, mikor kap a folyamat `SIGINT`/`SIGTERM`-et. A `packages/db` csak a
képességet adja (`DatabaseContext.recovery.recoverInterruptedRuns(reason)`), a tényleges hívás
mindkét esetben az `apps/server` fölött álló `packages/engine` felelőssége (`startup-recovery` és
`run-interrupt` téma, T-005-27).
...
hozzáadott `export { workflowTable } from './workflow-graph/workflow/workflow.ts';` sorra a három
...
(`graph-snapshot/stored-snapshot/graph-snapshot-immutability.spec.ts`).
...
- **Mi a viselkedés addig.** A lenyomat sosem hívói bemenet: kizárólag a `computeSnapshotHash`
  állítja elő a kanonikus szövegből (`graph-snapshot/snapshot-hash/compute-snapshot-hash.ts`), és a
