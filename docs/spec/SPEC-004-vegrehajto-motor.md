...
| --- | ------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| O-1 | A kifejezés nyelv és a sablon nyelv megválasztása                         | a motor a két befecskendezett porton át hív, saját nyelvet nem szállít; port nélkül a `branch`, `fan_out` és `loop` node-ot tartalmazó workflow indítása `expression_evaluator_unavailable` hibával elutasít; a sablon port hiánya az indítást nem utasítja el, hanem minden sablont renderelő lépés (`agent_step` `promptTemplate`, `human_approval` `bodyTemplate`) a futásakor, a sablon tartalmától függetlenül `template_render_failed` hibával bukik (mérve, `docs/research/2026-09-23-megszakitas-leallas-meres.md` 4. szekció) | külön termékdöntés a nyelvről, plusz egy spec a szállított implementációról                                                    |
