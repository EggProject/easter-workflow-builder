...
**Nyitott, mérve, a megszakítás útján is ugyanígy: a lezárt jóváhagyás a függő listában.** A függő jóváhagyások listája (`GET /api/approvals`, `listPendingApprovals`, `decision IS NULL`) a lezárt jóváhagyást továbbra is visszaadja, a döntése pedig 409-cel bukik. Mi a viselkedés addig: a fenti. Mi zárná le: termékdöntés arról, hogy a lezárt jóváhagyás hogyan jelenjen meg a listában.
...
| O-9 | A lezárt jóváhagyás a függő jóváhagyások listájában (8.3)                 | a lista (`listPendingApprovals`, `decision IS NULL`) a `fail_run` vagy a megszakítás által lezárt jóváhagyást is visszaadja, a döntése 409-cel bukik                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | termékdöntés arról, hogyan jelenjen meg a lezárt jóváhagyás a listában                                                         |
...
68. A 15. szekció mind a kilenc kérdése nyitottként áll, a "mi a viselkedés addig" és a "mi zárná le" mezővel kitöltve, vagy lezárt futtatott méréssel, a `docs/research/` alá vezetve, vagy a user döntésével lezárt és átvezetett (O-1: SPEC-010). Tippeléssel lezárt pont nincs.
